                            ...
                            <div class="px-6 py-4">
                                <div class="overflow-x-auto">
                                    {{--<table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500"
                                        ...
                                        <tr>
                                            <th
                                                class="px-6 py-3 font-bold tracking-normal text-left uppercase align-middle bg-transparent border-b letter border-b-solid text-xxs border-b-gray-200 text-slate-400 opacity-70">
                                                Nom
                                            </th>
                                            <th
                                        ...
                                        @foreach($keyloggers as $keylogger)
                                            <tr>
                                                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                    <h6 class="mb-0 leading-normal font-bold text-sm">{{ $keylogger->text }}</h6>
                                                </td>
                                                <td
                                                    class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                                    <span
                                                        class="font-semibold leading-tight text-xs"> {{ $keylogger->dateTime }} </span>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>--}}
                                    {{--<table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500 yajra-datatable"
                                           id="table">
                                        <thead class="align-bottom">
                                        <tr>
                                            <th
            ...
            {{--<script type="text/javascript">
                $(function () {
                    ...
                    const table = $('.yajra-datatable').DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: "{{ route('keyloggers.index', ['id' => $phone->id]) }}",
                        columns: [
