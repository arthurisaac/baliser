                ...
                <div class="w-full max-w-full px-3 mt-0 mb-6 md:mb-0 md:flex-none lg:flex-none">
                    <div
                        ...
                        <div class="flex-auto p-6 px-0 pb-2">
                            <div class="px-6 py-4">
                                <form action="{{ route("capture-audio-command") }}" method="post">
                                    @csrf

                                    <input type="hidden" name="id" value="{{ $phone->id }}">
                                    <input type="hidden" name="captureAudio" value="1">
                                    Durée <input type="range" name="captureAudioDuration" min="10" step="10" max="100000" value="10" checked>
                                    ...
                                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500"
                                        ...
                                        @foreach($captures as $capture)
                                            <tr>
                                                ...
                                                <td
                                                    class="p-2 leading-normal text-left align-middle bg-transparent border-b">
                                                    <a href="{{ url('uploads') . "/" . $capture->name }}" target="_blank"> Télécharger </a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
