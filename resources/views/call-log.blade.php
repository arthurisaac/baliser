                                        ...
                                        @foreach($callLogs as $callLog)
                                            <tr>
                                                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                    <h6 class="mb-0 leading-normal font-bold text-sm">{{ $callLog->number }}</h6>
                                                </td>
                                                <td
                                                    class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                                    <span
                                                        class="font-semibold leading-tight text-xs"> {{ $callLog->type == "1" ?  "Entrant" : "Sortant" }} </span>
                                                </td>
                                                <td class="p-2 align-middle bg-transparent border-b text-sky-600">
                                                    <p class=""> {{ $callLog->duration }}</p>
                                                </td>
                                                <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap text-center">
                                                    <span
                                                        class="font-semibold leading-tight text-xs"> {{ date("d-m-Y H:i", $callLog->date / 1000) }} </span>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
